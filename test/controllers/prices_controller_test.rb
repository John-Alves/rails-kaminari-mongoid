...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { benefit_tier: @price.benefit_tier, discount_value: @price.discount_value, ticket_id: @price.ticket_id, value: @price.value } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { benefit_tier: @price.benefit_tier, discount_value: @price.discount_value, ticket_id: @price.ticket_id, value: @price.value } }
